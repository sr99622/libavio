...
PYBIND11_MODULE(avio, m)
{
    ...
    py::class_<Player>(m, "Player")
        ...
        .def_readwrite("cbWidth", &Player::cbWidth)
        .def_readwrite("cbHeight", &Player::cbHeight)
        ...
        .def_readwrite("cbProgress", &Player::cbProgress)
        .def_readwrite("cbFrame", &Player::cbFrame)
        .def_readwrite("cbInfo", &Player::cbInfo)
        .def_readwrite("cbError", &Player::cbError);
